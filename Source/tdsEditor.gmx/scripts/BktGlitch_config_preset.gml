...
var dispersionAmount = sin_move(0.0015, 0.002, 10, 0);

switch (_preset){
    case BktGlitchPreset.A:       
        BktGlitch_set_intensity(1.000000);
        BktGlitch_set_line_shift(0.000100);
        BktGlitch_set_line_speed(0.001000);
        BktGlitch_set_line_resolution(1.000000);
        BktGlitch_set_line_drift(0.000000);
        BktGlitch_set_line_vertical_shift(0.050000);
        BktGlitch_set_noise_level(1.000000);
        BktGlitch_set_jumbleness(0.000500);
        BktGlitch_set_jumble_speed(0.006667);
        BktGlitch_set_jumble_resolution(0.03333333);
        BktGlitch_set_jumble_shift(0.160000);
        BktGlitch_set_channel_shift(0.000200);
        BktGlitch_set_channel_dispersion(dispersionAmount);
        BktGlitch_set_shakiness(0.200000);
