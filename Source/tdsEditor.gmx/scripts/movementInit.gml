///movementInit(gravity, friction, air_resistance, bounce, speed, accel, collision_object)
...
Speed = argument[4];
Acceleration = argument[5];
collision_object = argument[6] // The object that will be used for collisions.

horizontal_move_input = false;
vertical_move_input = false;

diagonalMultiplier = lengthdir_x(1, 45);
