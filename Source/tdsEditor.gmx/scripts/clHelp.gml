        ...
        case 2:
            {
                ...
                clAddBlank();
                clAddMessage("room_picture", baseColour);
                clAddMessage("Saves a picture showing the entire room to 'appSurf.png' in the save directory. (Doesn't work on HTML5.)", subColour);
